    ...
    public function messages(): array
    {
        return [
            'category_id.required' => __(
                'messages.category_id_required', [
                'attribute' => __('field_names.category_id',
                )]),
            'category_id.exists' => __(
                'messages.category_id_exists', [
                'attribute' => __('field_names.category_id',
                )]),
            ...
            'description.required' => __(
                'messages.description_required', [
                'attribute' => __('field_names.description',
                )]),
            'description.string' => __(
                'messages.description_string', [
                'attribute' => __('field_names.description',
                )]),
            'description.max' => __(
                'messages.description_max', [
                'attribute' => __('field_names.description',
                )]),

            'producer_id.required' => __(
                'messages.producer_id_required', [
                'attribute' => __('field_names.producer_id',
                )]),
            'producer_id.exists' => __(
                'messages.producer_id_exists', [
                'attribute' => __('field_names.producer_id',
                )]),

            'production_date.date' => __(
                'messages.production_date', [
